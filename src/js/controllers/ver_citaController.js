export class VerCitasController {
  ...
  inicializar() {
    ...
    // Control de seguridad: Solo el admin puede ver esta página
    if (!usuario || !usuario.admin) {
      Swal.fire({
        title: "Acceso Restringido",
        text: "Solo el administrador puede ver esta página de citas.",
        icon: "warning",
    ...
    // Pinta todas las citas del sistema en la primera carga de la pantalla
